...
public class CensusAndStateAnalyserTest {
    ...
    @Test
    public void givenIndiaCensusData_WithWrongFileDelimiterAndHeader_ShouldThrowException() {
        try {
            CensusAndStateAnalyser censusAndStateAnalyser = new CensusAndStateAnalyser();
    ...
    @Test
    public void givenIndiaStateData_WithWrongFileDelimiterAndHeader_ShouldThrowException() {
        try {
            CensusAndStateAnalyser censusAndStateAnalyser = new CensusAndStateAnalyser();
